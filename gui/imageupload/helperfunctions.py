...
def create_cnn_model():
    ...
    training_set = train_datagen.flow_from_directory('C:/Users/user/PycharmProjects/ImageUploadGUI/gui/imageupload/training_set',
                                                     target_size=(64, 64),
                                                     batch_size=batch_size,
                                                     class_mode='categorical')

    test_set = test_datagen.flow_from_directory('C:/Users/user/PycharmProjects/ImageUploadGUI/gui/imageupload/test_set',
                                                target_size=(64, 64),
                                                batch_size=batch_size,
                                                class_mode='categorical')
